...
class DataProcessing:
    ...
    def handle_imbalaned_data(self):
        try:
            ...
            logger.info("Handled imbalaned data succesfully")

        except Exception as e:
            logger.error(f"Error while processing imbalanced data {e}")
            raise CustomException(str(e))
